...
const toolRedirects: Record<string, string> = {
  ...
  "png-to-ico": "/convert/png-to-ico",
  "png-to-gif": "/convert/png-to-gif",
  "jpg-converter": "/tools",
  "jpg-to-bmp": "/convert/bmp-to-jpg",
  "mkv-to-mp4": "/convert/mkv-to-mp4",
  "wmv-to-mp4": "/convert/wmv-to-mp4",
  "flv-to-mp4": "/convert/flv-to-mp4",
  "m4v-to-mp4": "/convert/m4v-to-mp4",
  "3gp-to-mp4": "/convert/3gp-to-mp4",
  "ts-to-mp4": "/convert/ts-to-mp4",
  "mp4-to-mov": "/convert/mp4-to-mov",
  "mp4-to-avi": "/convert/mp4-to-avi",
  "mp4-to-mkv": "/convert/mp4-to-mkv",
  "jfif-to-jpg": "/convert/jfif-to-jpg",
  "jfif-to-png": "/convert/jfif-to-png",
  ...
  "avif-to-webp": "/convert/avif-to-webp",
  "svg-to-webp": "/convert/svg-to-webp",
  "svg-to-ico": "/convert/svg-to-ico",
