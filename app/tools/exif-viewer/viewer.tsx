        ...
        <section className="container mx-auto px-4 sm:px-6 pt-12 pb-8 sm:pt-20 sm:pb-12">
          ...
          >
            ...
            <p className="text-[#71717A] font-[Inter] text-base sm:text-lg max-w-xl mx-auto mb-10">
              View and remove EXIF metadata from your photos. Check camera info,
              GPS location, and more — then strip it all for privacy.
            </p>
          </motion.div>
        </section>
        ...
        <section className="container mx-auto px-4 sm:px-6 pb-16 sm:pb-24">
          ...
          >
            ...
            <p className="text-sm text-[#71717A] font-[Inter] mb-6">
              Create a free account or log in to view and remove EXIF data.
            </p>
            <Link
              href="/login"
