      ...
      <section className="container mx-auto px-4 sm:px-6 pt-12 pb-8 sm:pt-20 sm:pb-12">
        ...
        >
          ...
          <p className="text-[#71717A] font-[Inter] text-base sm:text-lg max-w-xl mx-auto">
            Remove comments, collapse whitespace, and optimize your CSS. Fast,
            ...
            {[
              {
                step: "01",
                title: "Paste CSS",
                desc: "Paste or type your CSS code into the input area.",
              },
              {
                step: "02",
                title: "Minify",
                desc: "Click Minify to remove comments and optimize whitespace.",
              },
              {
                step: "03",
                title: "Copy or Download",
                desc: "Copy the minified code or download it as a .css file.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.step}
